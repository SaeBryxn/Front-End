  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="fixed inset-y-0 left-0 z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0" :class="{ '-translate-x-full': !sidebarOpen }">
      <div class="flex items-center justify-center h-16 bg-primary-600">
        <h1 class="text-xl font-bold text-white">FuelTrack</h1>
      </div>
...
const navigation = [
  ...
  { name: 'Mis Pedidos', href: '/client/orders', icon: ClipboardDocumentListIcon },
  { name: 'Nuevo Pedido', href: '/client/create-order', icon: PlusIcon },
  { name: 'Pagos', href: '/client/payments', icon: CreditCardIcon },
  { name: 'Perfil', href: '/client/profile', icon: UserIcon }
]
</script>